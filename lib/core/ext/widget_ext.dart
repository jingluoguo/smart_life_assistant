...
extension WidgetExt on Widget {
  ...
  AspectRatio intoAspectRatio({Key? key, required double aspectRatio}) {
    return AspectRatio(key: key, aspectRatio: aspectRatio, child: this);
  }
  ...
  Offstage intoOffstage({Key? key, bool offstage = true}) {
  ...
  IgnorePointer intoIgnorePointer({
    Key? key,
    bool ignoring = true,
  ...
  Opacity intoOpacity({Key? key, required double opacity}) {
    return Opacity(opacity: opacity, key: key, child: this);
  }
  ...
  Flexible intoFlexible({Key? key, int flex = 1, FlexFit fit = FlexFit.loose}) {
  ...
  RotatedBox intoRotatedBox({Key? key, required int quarterTurns}) {
  ...
  Widget intoReorderableDragStartListener({
    Key? key,
    required int index,
    bool enabled = true,
  }) {
  ...
  Widget intoNotificationListener<T extends Notification>({
    Key? key,
  ...
  Widget intoCustomScrollConfiguration() {
    return ScrollConfiguration(behavior: _CustomScrollBehavior(), child: this);
  }

  Widget intoCustomSingleChildScrollView({
    Key? key,
    Axis scrollDirection = Axis.vertical,
    bool reverse = false,
    EdgeInsetsGeometry? padding,
...
// for not show android wave effect when scroll list view
